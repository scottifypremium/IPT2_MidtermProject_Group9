...
$conn = mysqli_connect("localhost", "root", "", "players2");
...
<div class="pagetitle">
  <h1>League of Legends Players List</h1>
</div><!-- End Page Title -->
...
<div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>RIOT ID:</strong> <span id="view_ml_id"></span></p>
...
$(document).ready(function() {
    ...
    $("#playerForm").submit(function(e) {
        ...
        $.post(id ? "update_player2.php" : "add_player2.php", data, function(response) {
...
$(".delete-btn").click(function() {
    ...
    if (confirm("Are you sure you want to delete this player?")) {
        $.post("delete_player2.php", { id: playerId }, function(response) {
            alert(response);
            location.reload();
        });
    }
